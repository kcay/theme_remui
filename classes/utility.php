...
class utility {
    ...
    public static function enable_edw_aw_menu() {
        ...
        if (get_config('theme_remui', 'enableaccessibilitytools')) {
            ...
            $PAGE->requires->js_call_amd('theme_remui/edw_aw_helper', 'init', ['issiteadmin' => is_siteadmin(), "feedbackstatus" => get_user_preferences('acs-feedback-status'), 'isloggedin' => isloggedin()]);
