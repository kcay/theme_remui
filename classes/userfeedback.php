...
class userfeedback {
    ...
    public  function get_user_info(){
        $userinfodata = [];
        $userinfodata['customername'] =  "";
        $userinfodata['email'] =  "";
        $userinfodata['pluginame'] = "";
        $userinfodata['licensekey'] =  "";



        if(get_config("theme_remui","edd_remui_setup_license_data")){
            $licensekey = get_config("theme_remui","edd_remui_license_key");

            $userinfo = json_decode(get_config("theme_remui","edd_remui_setup_license_data"),true);

            $userinfodata['customername'] = isset($userinfo['customer_name']) ? $userinfo['customer_name'] : "";

            $userinfodata['email'] = isset($userinfo['customer_email']) ? $userinfo['customer_email'] : "";

            $userinfodata['pluginame'] = isset($userinfo['item_name']) ? $userinfo['item_name'] : "";
